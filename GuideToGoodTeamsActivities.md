...
* Use a google doc or word doc that is collaborative and shared to anyone with the link (or if word, the meeting itself) to update for your notes.
  * This fosters better action and discussion (as the notes become a study guide), it also helps the TAs and instructors to see what you are working on.
...
The **team activity is a guided study session**, and it is only as effective as the team. **The more you put into it, the more you will get out of it.** Your overall goal isn't to finish every task and just go. Your goal is to learn and understand the material, and make sure all your team members better understand the material. This may mean more discussion, more questions, and more time. Other times, you may find the sessions go rather quick. 


If the team is stuck on the topic, seek support from the TA (during the CS 5005 meeting) or @ the TAs or instructors in a chat. If the request happens outside of the scheduled meeting, they will respond later with some resources and answers. If a team is really stuck, they may also ask to schedule an appointment with TA or instructor to help you all get caught up - this is good! Don't be afraid to ask for help. 
